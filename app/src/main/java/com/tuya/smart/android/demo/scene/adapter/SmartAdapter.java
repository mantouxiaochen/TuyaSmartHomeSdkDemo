...
//                @Override
//                public void onClick(View v) {
//                    if(null != mExecuteListener) mDeleteListener.onDelete(sceneBean);
//                }
//            });
            viewHolder.swtich.setVisibility(View.GONE);
//            viewHolder.swtich2.setVisibility(View.GONE);
        } else {
...
//            viewHolder.swtich2.setVisibility(View.VISIBLE);
...
//            viewHolder.swtich2.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    if(null != mSwitchListener) mSwitchListener.onSwitchAutomation(sceneBean);
//                }
...
//            swtich2 = itemView.findViewById(R.id.swtich2);
        }
    }
